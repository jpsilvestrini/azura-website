...
- [GitHub](https://github.com/azurajs/azura) - Contribute on GitHub
- [NPM](https://www.npmjs.com/package/azurajs) - Install via NPM
- [Documentation](/docs) - Explore the full documentation
await app.listen();
```
...
Check the full example in the [examples folder](https://github.com/azurajs/azura/tree/main/examples) of the repository.
...
<Cards>
  ...
  <Card title="GitHub Repository" href="https://github.com/azurajs/azura" description="Explore the source code" />
</Cards>
